...
# Configuración de Acestream Hash Resolver
ACESTREAM_RESOLVER_SOURCES = get_env("ACESTREAM_RESOLVER_SOURCES", "", str)
ACESTREAM_RESOLVER_REFRESH_INTERVAL = get_env("ACESTREAM_RESOLVER_REFRESH_INTERVAL", "1800", int)
ACESTREAM_RESOLVER_DOWNLOAD_TIMEOUT = get_env("ACESTREAM_RESOLVER_DOWNLOAD_TIMEOUT", "10", int)
ACESTREAM_RESOLVER_PROBE_TIMEOUT = get_env("ACESTREAM_RESOLVER_PROBE_TIMEOUT", "20", int)
ACESTREAM_RESOLVER_TOTAL_TIMEOUT = get_env("ACESTREAM_RESOLVER_TOTAL_TIMEOUT", "30", int)
ACESTREAM_RESOLVER_STABILITY_SAMPLE = get_env("ACESTREAM_RESOLVER_STABILITY_SAMPLE", "5", int)
ACESTREAM_RESOLVER_RESOLUTION_MODE = get_env("ACESTREAM_RESOLVER_RESOLUTION_MODE", "probe", str)
